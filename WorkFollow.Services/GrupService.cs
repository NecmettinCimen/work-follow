...
public class GrupService : IGrupService
{
    ...
    {
        const string sql =
            @"INSERT INTO public.grup(aktif, sil, olusturmatarihi, olusturankisi, guncellemetarihi, guncelleyenkisi, ad, aciklama, yoneticiid)
    ...
    {
        const string sql =
            @"update public.grup set guncelleyenkisi = @guncelleyenkisi, ad = @ad, aciklama = @aciklama where id = @id";
