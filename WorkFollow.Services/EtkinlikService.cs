...
public class EtkinlikService : IEtkinlikService
{
    ...
    {
        const string sql =
            @"SELECT id, sil, olusturmatarihi, olusturankisi, guncellemetarihi, guncelleyenkisi, baslik, aciklama, durumid, kategoriid, baslangictarihi, bitistarihi, atananid, projeid
